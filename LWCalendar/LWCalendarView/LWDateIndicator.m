...
-(UILabel *)titleLabel{
    if (_titleLabel == nil) {
        ...
        _titleLabel.font = [UIFont boldSystemFontOfSize:LWDATEINICATOR_TITLE_FONT_SIZE];
        ...
        NSLayoutConstraint *viewHeight = [NSLayoutConstraint constraintWithItem:_titleLabel attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:LWDATEINICATOR_TITLE_HEIGHT];
...
-(UILabel *)dateLabel{
    if (_dateLabel == nil) {
        ...
        _dateLabel.font = [UIFont boldSystemFontOfSize:LWDATEINICATOR_DATE_FONT_SIZE];
        _dateLabel.textColor= [UIColor whiteColor];
        _dateLabel.backgroundColor = LWDATEPICKERVIEW_SELECTED_COLOR;
